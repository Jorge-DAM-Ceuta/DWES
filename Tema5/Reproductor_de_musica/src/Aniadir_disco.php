...
$arrayJSON = Disco::decodificarDiscos();
$nuevoID = Disco::obtenerUltimoID_Disco($arrayJSON) + 1;
...
if (isset($_POST["aniadir"]) && $_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    Disco::aniadirDisco($arrayJSON, $nuevoDisco);
}
?>
...
<body>
    ...
    <form action="" method='POST' enctype='multipart/form-data'>
        ...
        <br />
        <input type='submit' name='aniadir' value='Añadir disco'>
    </form>
</body>
